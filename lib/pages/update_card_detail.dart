// ignore_for_file: prefer_typing_uninitialized_variables, prefer_final_fields, non_constant_identifier_names, no_leading_underscores_for_local_identifiers, use_build_context_synchronously, unused_field, unnecessary_brace_in_string_interps, unnecessary_string_interpolations
...
class UpdateCardDetails extends StatefulWidget {
  SqfliteDbModel1? data1;
   UpdateCardDetails (this.data1, {Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _UpdateCardDetailsState createState() => _UpdateCardDetailsState();
}

class _UpdateCardDetailsState extends State<UpdateCardDetails> {

  String _button = "insertintocard";
  ...
  _updateCardData(
    ...
    await SqfliteDatabase().updateCardData(data1);
  }
}
